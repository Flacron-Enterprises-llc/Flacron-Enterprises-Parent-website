...
const styles: Record<ToastType, string> = {
  ...
  info: "border-orange-200 bg-orange-50 dark:bg-orange-950/30 dark:border-orange-800",
};
      ...
      <div className="fixed bottom-20 right-6 z-50 flex flex-col gap-2 w-72">
        <AnimatePresence>
          {toasts.map((t) => (
            ...
            >
              {icons[t.type]}
              <p className="flex-1 text-sm font-medium text-flacron-navy dark:text-slate-100 leading-snug">{t.message}</p>
